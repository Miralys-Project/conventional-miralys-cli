...
// src/cli/package.json.ts
import inquirer from 'inquirer';
import { execa } from 'execa';
import { readFile, writeFile } from 'fs/promises';
import path from 'path';
async function run() {
	console.log('\u{1F680} Project initializing...');
	...
	Object.assign(pkg, {
		...
		repository: answers.repository
			...
			: void 0,
		homepage: answers.homepage || void 0,
		bugs: answers.bugs ? { url: answers.bugs } : void 0,
		private: answers.private || void 0,
	...
	console.log('\u2705 package.json cr\xE9\xE9 avec succ\xE8s !');
}

// src/index.ts
console.log(source_default.blue('Welcome to Conventional Miralys CLI'));
run().catch((err) => {
